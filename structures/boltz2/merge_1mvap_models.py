#!/usr/bin/env python3
"""Merge 1-MVAP batch models (seeds 5-49) into existing prediction directories as model_5 through model_49."""

import shutil
import sys
from pathlib import Path

OUTPUT_DIR = Path("/nfs/lambda_stor_01/homes/rzhu/PMD/structures/boltz2/output")

VARIANTS = [
    "PMDsc_WT",
    "PMDsc_Y19H",
    "PMDsc_R74G",
    "PMDsc_R74G_R147K_M212Q",
    "PMDsc_R74H_R147K_M212Q",
]
...
def merge_variant(variant):
    ...
    merged = 0
    for i, seed in enumerate(range(5, 50)):
        model_idx = 5 + i
